 ...
 */
final class Version20260914120814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, ecole_id INT DEFAULT NULL, created_by INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, capacite INT DEFAULT NULL, code VARCHAR(50) DEFAULT NULL, enabled TINYINT(1) DEFAULT NULL, deleted TINYINT(1) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8F87BF9677153098 (code), INDEX IDX_8F87BF9677EF1B1E (ecole_id), INDEX IDX_8F87BF96DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE inscription ADD CONSTRAINT FK_5E90F6D6DE12AB56 FOREIGN KEY (created_by) REFERENCES `user` (id)');
