 ...
 */
final class Version20251010162131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, demographic_id INT DEFAULT NULL, company_id INT DEFAULT NULL, created_by INT DEFAULT NULL, phone VARCHAR(25) DEFAULT NULL, code VARCHAR(255) NOT NULL, enabled TINYINT(1) DEFAULT NULL, deleted TINYINT(1) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_D79F6B11FF964730 (demographic_id), INDEX IDX_D79F6B11979B1AD6 (company_id), INDEX IDX_D79F6B11DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
